 ...
 * @author Nam
 */
public class TamTruMainPage extends javax.swing.JFrame {

    /**
     * Creates new form NhanKhauMainPage
     */
    public TamTruMainPage() {
        initComponents();
        displayTamTru();
    }
...
"FROM tam_tru \n"+
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TamTruMainPage.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TamTruMainPage().setVisible(true);
            }
        });
    }
