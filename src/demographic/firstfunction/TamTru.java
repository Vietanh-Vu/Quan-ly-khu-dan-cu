...
public class TamTru extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tfIdTamTru = new javax.swing.JTextField();
        ...
        jLabel8.setText("Số giấy tạm trú");

        tfIdTamTru.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                tfIdTamTruActionPerformed(evt);
            }
        });
                        ...
                        .addGroup(nhanKhauPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addGroup(nhanKhauPanelLayout.createSequentialGroup()
                                .addGroup(nhanKhauPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(tfIdTamTru, javax.swing.GroupLayout.PREFERRED_SIZE, 100, javax.swing.GroupLayout.PREFERRED_SIZE))
            ...
            .addGroup(nhanKhauPanelLayout.createSequentialGroup()
                ...
                .addGroup(nhanKhauPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(nhanKhauPanelLayout.createSequentialGroup()
                        .addComponent(jLabel8)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(tfIdTamTru, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(nhanKhauPanelLayout.createSequentialGroup()
                        .addComponent(jLabel9)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void tfIdTamTruActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tfIdTamTruActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_tfIdTamTruActionPerformed
    ...
    // ------------- DISPLAY PEOPLE ---------------------
    private void displayTamTru(){
        try {
            conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/demographic","root","");
            st = conn.createStatement();
            String sql = "SELECT\n" +
"    so_giay_tam_tru AS 'Số giấy tạm trú',\n" +
"    tam_tru.so_CMND AS 'Số CMND',\n" +
"    nhan_khau.ho_ten AS 'Họ và tên',\n" +
"    thoi_gian AS 'Thời gian',\n" +
"    li_do AS 'Lý do' \n" +
"FROM tam_tru JOIN nhan_khau ON tam_tru.so_CMND = nhan_khau.so_CMND;";
    ...
    private void btnLuuMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnLuuMouseClicked
        ...
        if (tfCMND.getText().isEmpty() ||
            ...
            try {
                conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/demographic","root","");
                PreparedStatement add = conn.prepareStatement("INSERT INTO tam_tru VALUES (?,?,?,?) ");
                add.setString(1, tfIdTamTru.getText());
    ...
    private void btnXoaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnXoaMouseClicked
        ...
        if (key.equals("")) {
            ...
            try {
                conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/demographic","root","");
                String query = "Delete From tam_tru where so_giay_tam_tru = \"" + key + "\"";
    ...
    private void tTamTruMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tTamTruMouseClicked
        ...
        try {
                conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/demographic","root","");
                String query = "SELECT * FROM tam_tru where so_giay_tam_tru = \"" + key + "\"";
                Statement statement = conn.createStatement();
                ResultSet resultSet = statement.executeQuery(query);
                while (resultSet.next()) {
                    tfIdTamTru.setText(resultSet.getString("so_giay_tam_tru"));
    ...
    private void btnSuaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnSuaMouseClicked
        ...
        if (key.equals("")) {
            ...
            try {
                conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/demographic","root","");
                String query = "Update tam_tru Set so_giay_tam_tru = ?, "
                        + "so_CMND = ?, "
                        + "thoi_gian = ?, "
                        + "li_do = ? "
                        + "where so_giay_tam_tru = \"" + key + "\"";
                PreparedStatement update = conn.prepareStatement(query);
                update.setString(1, tfIdTamTru.getText());
                ...
                JOptionPane.showMessageDialog(this, "Đã sửa thông tin của giấy tạm trú");
                conn.close();
                displayTamTru();
                clearAfterAdding();
            }
    ...
    private void btnTimMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnTimMouseClicked
        ...
        try {
            conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/demographic","root","");
            st = conn.createStatement();
            String idTamTru = tfIdTamTru.getText();
...
"    li_do AS 'Lý do',\n" +
"FROM tam_tru \n"+
                    "WHERE (so_giay_tam_tru = \"" + idTamTru + "\" or \"\" = \"" + idTamTru + "\") " + 
    ...
    private javax.swing.JTextField tfIdTamTru;
