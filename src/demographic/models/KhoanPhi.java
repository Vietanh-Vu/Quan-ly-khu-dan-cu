...
public class KhoanPhi {
    ...
    public KhoanPhi(int idKhoanPhi, String tenKhoanPhi, String tienPhi, String ngayBatDau, String ngayKetThuc, String chiTiet, String loaiPhi) {
    ...
    public String toString() {
        return "KhoanPhi{" + "idKhoanPhi=" + idKhoanPhi + ", tenKhoanPhi=" + tenKhoanPhi + ", tienPhi=" + tienPhi + ", ngayBatDau=" + ngayBatDau + ", ngayKetThuc=" + ngayKetThuc + ", chiTiet=" + chiTiet + ", loaiPhi=" + loaiPhi + '}';
    }
