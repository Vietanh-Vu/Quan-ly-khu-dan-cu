 ...
 * @author Nam
 */
public class ThemNhanKhauForm extends javax.swing.JFrame {
        ...
        if (
            ...
            try {
                ...
                String sql = "INSERT INTO nhan_khau (ho_ten, biet_danh, gioi_tinh, ngay_sinh, "
                        ...
                        + "noi_lam_viec, quan_he_voi_chu_ho, ngay_dang_ky_thuong_tru, dia_chi_truoc_khi_chuyen, so_ho_khau, qua_doi, chuyen_di)\n" 
                        + "VALUES('" + tfHoTen.getText() + "',"
                        + "'"+ tfBietDanh.getText() + "',"
                        ...
                        + "'" + tfNoiCap.getText() + "',"
                        + "'" + tfNoiSinh.getText() + "',"
                        + "'" + tfNguyenQuan.getText() + "',"
                        + "'" + tfDanToc.getText() + "',"
                        + "'" + tfNgheNghiep.getText() + "',"
                        + "'" + tfNoiLamViec.getText() + "',"
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ThemNhanKhauForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ThemNhanKhauForm().setVisible(true);
            }
        });
    }
