...
public class TamTruMainPage extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel6.setText("QUẢN LÝ TẠM TRÚ");
...
//            System.out.println(hoKhau.toString());
    ...
    private void btnTimMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnTimMouseClicked
        ...
        try {
            ...
            String sql = "SELECT \n" +
                    "    tam_tru_id AS 'ID Tạm trú',\n" +
                    "    ho_ten AS 'Họ tên',\n" +
                    "    ngay_sinh AS 'Ngày sinh',\n" +
                    "    so_CMND AS 'Số CMND',\n" +
                    "    ngay_cap AS 'Ngày cấp',\n" +
                    "    noi_cap AS 'Nơi cấp',\n" +
                    "    gioi_tinh AS 'Giới tính',\n" +
                    "    dia_chi_thuong_tru AS 'Địa chỉ thường trú',\n" +
                    "    cho_o_hien_tai AS 'Chỗ ở hiện tại',\n" +
                    "    ly_do AS 'Lý do',\n" +
                    "    ngay_tam_tru AS 'Ngày tạm trú'\n" +
                    "FROM tam_tru\n" +
                    "WHERE tam_tru.ho_ten = '" + thongTin + "'\n" +
                    "AND deleted = 0;";
    ...
    private void btnSuaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnSuaMouseClicked
        ...
        SuaXoaTamTruForm newForm =  new SuaXoaTamTruForm(tamTru);
        newForm.setVisible(true);
